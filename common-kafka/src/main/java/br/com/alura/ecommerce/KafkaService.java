...
public class KafkaService<T> implements Closeable {
    ...
    // Construtor quando recebe um único tópico para ser ouvido
    ...
    // Construtor quando você recebe uma lista de tópicos
    ...
    public void run() {
        while(true) {
            // A cada 1s eu quero que veja se tem alguma mensagem para ser ouvida
            ...
            for (var record : records) {
                try {
                    ...
                    // Por enquanto, apenas loggar a mensagem de excessão
                    e.printStackTrace();
                }
            }
        }
